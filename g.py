...
class Mensagem:
    usuario: str
    texto: str
    tipo_msg: str  # Corrigido para ser um campo da instância

    def __del__(self):
        print(f"{self.usuario} destruído com sucesso.")  # Não deve retornar, mas sim logar a mensagem
...
def main(page: ft.Page):
    ...
    def on_msg(msg: Mensagem):
        if msg.tipo_msg == "chat_message":
            ...
            pass  # Tratamento para outras mensagens
        page.update()
